...
Blockly.CSharp['text_prompt_ext'] = function(block) {
    ...
    var functionName = Blockly.CSharp.variableDB_.getDistinctName('text_prompt_extInput', Blockly.Generator.NAME_TYPE);
    Blockly.CSharp.text_prompt_ext.promptInput = functionName;
    var func = [];
    ...
    func.push('});');
    Blockly.CSharp.definitions_['text_prompt_extInput'] = func.join('\n');

    var code = Blockly.CSharp.text_prompt_ext.promptInput + '(' + msg + ', ' + toNumber + ')';
    return [code, Blockly.CSharp.ORDER_FUNCTION_CALL];
};
